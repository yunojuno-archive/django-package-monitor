...
REQUIREMENTS_FILE = getattr(
    settings, "PACKAGE_MONITOR_REQUIREMENTS_FILE", None
) or getenv("PACKAGE_MONITOR_REQUIREMENTS_FILE", None)
...
if not path.exists(REQUIREMENTS_FILE):
    raise ImproperlyConfigured(
        "Invalid REQUIREMENTS_FILE setting: %s" % REQUIREMENTS_FILE
    )
